...
namespace FaceTrackingBasics
{
    ...
    public partial class FaceTrackingViewer : UserControl, IDisposable
    {
        ...
        private void PrintFile(EnumIndexableCollection<FeaturePoint, Vector3DF> collection, string path)
        {
        ...
        private class SkeletonFaceTracker : IDisposable
        {
            ...
            public EnumIndexableCollection<FeaturePoint, Vector3DF> FaceModel { get; private set; }

            public FaceTracker FaceTracker { get; private set; }
            ...
            internal void OnFrameReady(KinectSensor kinectSensor, ColorImageFormat colorImageFormat, byte[] colorImage, DepthImageFormat depthImageFormat, short[] depthImage, Skeleton skeletonOfInterest)
            {
                ...
                if (this.FaceTracker != null)
                {
                    ...
                    if (this.lastFaceTrackSucceeded)
                    {
                        ...
                        this.FaceModel = frame.Get3DModel();
                    }
                }
            }
